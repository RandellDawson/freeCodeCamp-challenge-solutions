...
ChildObject.prototype using the same method name as the one to override.
...
If you have an instance let duck = new Bird(); and you call duck.eat(), this is how JavaScript looks
for the method on duck’s prototype chain:
