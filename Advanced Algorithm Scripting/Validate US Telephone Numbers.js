...
The following are examples of valid formats for US numbers (refer to the tests below for other
variants):
...
function telephoneCheck(str) {
  return /^1?(\([1-9]\d{2}\)|[1-9]\d{2})-?[1-9]\d{2}-?\d{4}$/.test(str.replace(/\s/g,""));
}
