...
You are given a JSON object representing a part of your musical album collection. Each album
has several properties and a unique id number as its key. Not all albums have complete information.
...
function updateRecords(id, prop, value) {
  if (value) {
    if (prop === "tracks") {
      var propVal = collection[id][prop] ? value : [value]
      collection[id][prop] = collection[id][prop].concat(propVal)
    }
    else collection[id][prop] = value;
  }
  else  delete collection[id][prop];
